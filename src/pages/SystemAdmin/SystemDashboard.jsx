      ...
      <header className="sticky top-0 z-30 backdrop-blur-md bg-white/80 dark:bg-slate-900/75 border-b border-slate-200 dark:border-slate-800/80 px-6 py-4 flex items-center justify-between transition-colors duration-350">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            className="p-2.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 transition-all duration-200 shadow-sm border border-slate-200 dark:border-slate-750"
