                  ...
                  return (
                    <React.Fragment key={o.id}>
                      ...
                      >
                        ...
                        {visibleColumns.includes('customer_code') && <td className="py-3.5 px-4 font-bold text-gray-600">{o.customer_code}</td>}
                        {visibleColumns.includes('customer_name') && <td className="py-3.5 px-4 font-bold text-gray-800">{o.customer_name}</td>}
                        {visibleColumns.includes('total') && <td className="py-3.5 px-4 text-right font-extrabold text-gray-900">{fmt(o.total)}</td>}
                        {visibleColumns.includes('must_pay_customer') && <td className="py-3.5 px-4 text-right font-extrabold text-amber-600">{fmt(o.must_pay_customer)}</td>}
                        {visibleColumns.includes('paid_customer') && <td className="py-3.5 px-4 text-right font-extrabold text-emerald-600">{fmt(o.paid_customer)}</td>}
                        {visibleColumns.includes('status') && (
