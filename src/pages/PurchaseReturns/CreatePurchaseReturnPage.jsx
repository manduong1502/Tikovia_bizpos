    ...
    <div className="flex flex-col h-[calc(100vh-90px)] -m-5 bg-gray-100 font-sans">
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between shadow-sm z-20 shrink-0">
        <div className="flex items-center gap-6">
          ...
          <div className="relative w-96">
            <input 
              ...
              className="w-full pl-9 pr-4 py-1.5 bg-gray-50 border border-gray-300 rounded-md text-xs focus:outline-none focus:bg-white focus:border-primary transition-all shadow-inner"
            />
        ...
        <div className="flex items-center gap-2">
          <Button variant="secondary" className="flex items-center gap-1.5 text-xs py-1.5 px-3">
            <Printer size={14} />
          </Button>
          <Button variant="secondary" className="flex items-center gap-1.5 text-xs py-1.5 px-3">
            <Eye size={14} />
          </Button>
          <Button variant="secondary" className="flex items-center gap-1.5 text-xs py-1.5 px-3 text-amber-600">
            <AlertCircle size={14} />
          </Button>
        </div>
      </div>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 bg-white overflow-y-auto flex flex-col">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-100 text-gray-700 text-xs font-bold border-b border-gray-200 sticky top-0 z-10 shadow-sm">
                <th className="py-3 px-4 w-12 text-center"></th>
                <th className="py-3 px-4 w-16 text-center">STT</th>
                <th className="py-3 px-4 w-32">Mã hàng</th>
                <th className="py-3 px-4 flex-1">Tên hàng</th>
                <th className="py-3 px-4 w-24 text-center">ĐVT</th>
                <th className="py-3 px-4 w-36 text-right">Số lượng</th>
                <th className="py-3 px-4 w-32 text-right">Giá nhập</th>
                <th className="py-3 px-4 w-32 text-right">Giá trả lại</th>
                <th className="py-3 px-4 w-36 text-right font-extrabold text-primary">Thành tiền</th>
              </tr>
            </thead>
                ...
                <tr key={it.id} className="hover:bg-blue-50/50 transition-colors group">
                  ...
                  <td className="py-3 px-4">
                    ...
                    <div className="flex items-center gap-1.5">
                      <input 
                        ...
                        placeholder="Ghi chú..." 
                        className="text-[11px] text-gray-500 italic bg-transparent border-b border-dashed border-gray-300 focus:border-primary focus:outline-none px-1 py-0.5 w-48"
                      />
                      <Edit2 size={12} className="text-gray-400" />
                    </div>
                  </td>
                  <td className="py-3 px-4 text-center text-gray-600">{it.unit}</td>
                  <td className="py-3 px-4 text-right">
                    <div className="flex items-center justify-end gap-1.5">
                      <input 
                        ...
                        className="w-16 py-1 px-2 text-right font-bold text-gray-900 border border-gray-300 rounded focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary shadow-inner"
                      />
                  ...
                  <td className="py-3 px-4 text-right">
                    <input 
                      ...
                      className="w-24 py-1 px-2 text-right font-bold text-gray-900 border border-gray-300 rounded focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary shadow-inner"
                    />
                  </td>
        ...
        {/* Right Panel Section */}
        <div className="w-[380px] bg-white border-l border-gray-200 flex flex-col shadow-lg z-10 shrink-0">
          <div className="flex-1 overflow-y-auto p-6 space-y-5">
            ...
            <div className="flex items-center gap-3">
              <div className="flex-1 relative">
                <select 
                  ...
                  className="w-full pl-3 pr-8 py-2 bg-gray-50 border border-gray-300 rounded-lg text-xs font-bold text-gray-800 focus:outline-none focus:border-primary appearance-none shadow-sm cursor-pointer"
                >
                  {employees.map(emp => (
              ...
              <input 
                ...
                className="w-36 py-2 px-2 bg-gray-50 border border-gray-300 rounded-lg text-[11px] font-bold text-gray-700 focus:outline-none focus:border-primary shadow-sm"
              />
            </div>
            ...
            <div>
              ...
              <div className="py-2 px-3 bg-gray-50 border border-gray-200 rounded-lg text-xs font-bold text-gray-800 shadow-inner">
            ...
            <div>
              ...
              <input 
                ...
                className="w-full py-2 px-3 bg-gray-100 border border-gray-200 rounded-lg text-xs font-bold text-gray-500 placeholder-gray-400 shadow-inner cursor-not-allowed"
              />
            </div>
            ...
            <div>
              ...
              <div className="text-xs font-bold text-emerald-600 bg-emerald-50 border border-emerald-200 py-1.5 px-3 rounded-lg inline-block shadow-sm">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between text-xs">
                ...
                <input 
                  ...
                  placeholder="0"
                  className="w-28 py-1 px-2 text-right font-bold text-gray-900 border border-gray-300 rounded focus:outline-none focus:border-primary shadow-inner"
                />
              </div>
              ...
              <div className="flex items-center justify-between text-xs">
                ...
                <input 
                  ...
                  className="w-32 py-1.5 px-2 text-right font-extrabold text-gray-900 border border-gray-300 rounded focus:outline-none focus:border-primary shadow-inner bg-blue-50/30"
                />
              </div>
            ...
            <div>
              ...
              <textarea 
                ...
                rows={3}
                placeholder="Ghi chú..." 
                className="w-full p-3 bg-gray-50 border border-gray-300 rounded-lg text-xs text-gray-800 focus:outline-none focus:border-primary shadow-inner resize-none"
              />
            </div>
          </div>

          {/* Bottom Action Buttons */}
          <div className="p-6 bg-gray-50 border-t border-gray-200 flex items-center gap-3 shadow-md shrink-0">
            <Button 
              variant="secondary" 
              disabled={saving}
              onClick={() => handleSaveReturn('PENDING')}
              className="flex-1 py-3 text-xs font-bold border border-gray-300 bg-white text-gray-700 hover:bg-gray-100 shadow-sm cursor-pointer"
            >
              Lưu tạm
            </Button>
            <Button 
              ...
              className="flex-1 py-3 text-xs font-bold bg-primary hover:bg-primary-hover text-white shadow-lg cursor-pointer border-none"
            >
              Hoàn thành
            </Button>
          </div>
