...
export default function ExportDebtModal({ open, onClose, onExport }) {
  ...
  const [columns, setColumns] = useState({
    ...
    import_price: true, // Giá nhập/trả
          ...
          <div>
            ...
            <div className="border border-gray-200 rounded-xl overflow-hidden">
              ...
              <div className="p-4 pl-12 space-y-3 bg-white">
                ...
                <label className="flex items-center gap-3 cursor-pointer group">
                  <input type="checkbox" checked={columns.import_price} onChange={() => handleToggleColumn('import_price')} className="w-4 h-4 text-primary rounded border-gray-300 focus:ring-primary cursor-pointer" />
