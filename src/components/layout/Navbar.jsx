...
export default function Navbar({ mobileMenuOpen, setMobileMenuOpen }) {
  ...
  const navItemBase = "relative h-full flex items-center px-3 lg:px-4 text-white/85 text-[13px] font-medium cursor-pointer transition-all no-underline hover:bg-white/10 hover:text-white group whitespace-nowrap";
